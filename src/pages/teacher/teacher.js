    ...
    render() {
        ...
        return (
            <Card title={title} extra={rightBtn}>
                ...
                <AddMenu visible={this.state.showNum === 1} hideFunc={this._hideAddPane} parentID={this.state.currentParentMenu.id ? this.state.currentParentMenu.id : 0}/>
                <EditMenu visible={this.state.showNum === 2} hideFunc={this._hideAddPane} editMenu = {this.state.editMenu}/>
            </Card>
        )
    }
}
